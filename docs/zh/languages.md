...
> 英文版：[languages.md](../languages.md)

OmniVoice 支持 **646 种语言**，训练数据合计约 **58.1 万小时**。

下表列出各语言的 OmniVoice 语言 ID、ISO 639-3 代码与训练时长（小时）。语言名称保留英文专名以便与 ISO/数据集对照。

| # | 语言 | OmniVoice ID | ISO 639-3 | 时长 (h) |
|--:|----------|:------------:|:---------:|:------------:|
...
*共 646 种语言，合计约 58.1 万小时。*

数据来源：[lang_id_name_map.tsv](../lang_id_name_map.tsv)
